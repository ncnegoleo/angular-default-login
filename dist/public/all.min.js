!function(){"use strict";function a(a,b,c,d,e,f){function g(a,b,c){d(function(){e.authenticate(a,b).then(function(a){c(a)})},1e3)}function h(d,e,g){var h=f.encode(d+":"+e);c.globals={currentUser:{username:d,authdata:h,token:g}},a.defaults.headers.common.Authorization="Basic "+h;var i=new Date;i.setDate(i.getDate()+7),b.putObject("globals",c.globals,{expires:i})}function i(){c.globals={},b.remove("globals"),a.defaults.headers.common.Authorization="Basic"}var j={};return j.login=g,j.setCredentials=h,j.clearCredentials=i,j}angular.module("app").factory("AuthenticationService",a),a.$inject=["$http","$cookies","$rootScope","$timeout","UserService","Base64"]}(),function(){"use strict";function a(a){function b(b,c){a.flash={message:b,type:"success",keepAfterLocationChange:c}}function c(b,c){a.flash={message:b,type:"error",keepAfterLocationChange:c}}function d(b,c){a.flash={message:b,type:"warning",keepAfterLocationChange:c}}var e={};return e.success=b,e.error=c,e.warning=d,function(){function b(){var b=a.flash;b&&(b.keepAfterLocationChange?b.keepAfterLocationChange=!1:delete a.flash)}a.$on("$locationChangeStart",function(){b()})}(),e}angular.module("app").factory("FlashService",a),a.$inject=["$rootScope"]}(),function(){"use strict";function a(a){function b(){return a.get("/api/users").then(g,h("Error getting all users"))}function c(b){return a.get("/api/users/"+b).then(g,h("Error getting by id"))}function d(b){return a.get("/api/users/"+b).then(g,h("Error getting by username"))}function e(b){return a.post("/api/users",b).then(g,h("Error creating user"))}function f(b,c){return a.post("/api/authenticate",{username:b,password:c}).then(g,h("Error creating user"))}function g(a){return a.data}function h(a){return function(){return{success:!1,message:a}}}var i={};return i.getAll=b,i.getById=c,i.getByUsername=d,i.create=e,i.authenticate=f,i}angular.module("app").factory("UserService",a),a.$inject=["$http"]}(),function(){"use strict";angular.module("app").value("Base64",{keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(a){var b,c,d,e,f,g="",h="",i="",j=0;do{b=a.charCodeAt(j++),c=a.charCodeAt(j++),h=a.charCodeAt(j++),d=b>>2,e=(3&b)<<4|c>>4,f=(15&c)<<2|h>>6,i=63&h,isNaN(c)?f=i=64:isNaN(h)&&(i=64),g=g+this.keyStr.charAt(d)+this.keyStr.charAt(e)+this.keyStr.charAt(f)+this.keyStr.charAt(i),b=c=h="",d=e=f=i=""}while(j<a.length);return g},decode:function(a){var b,c,d,e,f,g="",h="",i="",j=0;/[^A-Za-z0-9\+\/\=]/g.exec(a)&&window.alert("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."),a=a.replace(/[^A-Za-z0-9\+\/\=]/g,"");do{d=this.keyStr.indexOf(a.charAt(j++)),e=this.keyStr.indexOf(a.charAt(j++)),f=this.keyStr.indexOf(a.charAt(j++)),i=this.keyStr.indexOf(a.charAt(j++)),b=d<<2|e>>4,c=(15&e)<<4|f>>2,h=(3&f)<<6|i,g+=String.fromCharCode(b),64!=f&&(g+=String.fromCharCode(c)),64!=i&&(g+=String.fromCharCode(h)),b=c=h="",d=e=f=i=""}while(j<a.length);return g}})}(),function(){"use strict";function a(a,b,c,d,e){function f(){e.unwatch(),c.path("/login"),d.clearCredentials()}var g=this;g.user=null,g.logout=f,function(){a.getByUsername(b.globals.currentUser.username).then(function(a){a?(g.user=a,g.token=b.globals.currentUser.token,e.watch()):f()})}()}angular.module("app").controller("HomeController",a),a.$inject=["UserService","$rootScope","$location","AuthenticationService","Idle"]}(),function(){"use strict";function a(a,b,c){function d(){b.login(e.username,e.password,function(d){d.success?(b.setCredentials(e.username,e.password,d.token),a.path("/")):c.error(d.message)})}var e=this;e.login=d}angular.module("app").controller("LoginController",a),a.$inject=["$location","AuthenticationService","FlashService"]}(),function(){"use strict";function a(a,b,c,d){function e(){var c=f.user;c.password=c.password,a.create(c).then(function(a){a.success?(d.success("Registration successful!",!0),b.path("/login")):d.error(a.message)})}var f=this;f.register=e}angular.module("app").controller("RegisterController",a),a.$inject=["UserService","$location","Base64","FlashService"]}();
